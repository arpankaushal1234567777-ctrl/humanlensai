  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-black overflow-hidden">
      ...
      <div className="pointer-events-none absolute inset-0">
        {/* Top-center orb */}
        <div className="absolute top-[-180px] left-1/2 -translate-x-1/2 w-[700px] h-[500px] rounded-full bg-white/[0.03] blur-[100px]" />
        {/* Subtle blue tint bottom */}
        <div className="absolute bottom-[-120px] left-1/2 -translate-x-1/2 w-[500px] h-[400px] rounded-full bg-sky-500/[0.04] blur-[120px]" />
      </div>
